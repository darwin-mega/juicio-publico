  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {isOffline && (
          <div className="info-box warning" style={{ fontSize: 'var(--text-xs)', textAlign: 'center' }}>
            El modo multidispositivo necesita internet. El modo mesa funciona en este dispositivo.
          </div>
        )}
        ...
        >
          {user?.user_metadata?.avatar_url ? (
            // The remote OAuth avatar URL is already sized and cannot use the default Next image loader.
            // eslint-disable-next-line @next/next/no-img-element
            <img
              src={user.user_metadata.avatar_url}
              alt=""
              referrerPolicy="no-referrer"
              style={{ width: 28, height: 28, borderRadius: '50%', objectFit: 'cover', border: '1px solid rgba(255,255,255,0.25)' }}
            />
          ) : (
            <span style={{ width: 28, height: 28, borderRadius: '50%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-base)', border: '1px solid rgba(255,255,255,0.2)' }}>
        ...
        <button
          ...
          style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)', borderColor: 'rgba(255,255,255,0.2)' }}
        >
          🚪 Cerrar sesión
        </button>
