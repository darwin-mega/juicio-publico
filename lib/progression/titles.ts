...
export const PROGRESS_TITLES: ProgressTitleDefinition[] = [
  ...
  { id: 'killer_250', group: 'killer', metric: 'killer.kills', threshold: 250, title: 'Fantasma Público' },
  ...
  { id: 'doctor_250', group: 'doctor', metric: 'doctor.correctSaves', threshold: 250, title: 'Ángel de Guardia' },
  { id: 'doctor_500', group: 'doctor', metric: 'doctor.correctSaves', threshold: 500, title: 'Milagro Público' },
  ...
  { id: 'games_50', group: 'general_games', metric: 'gamesPlayed', threshold: 50, title: 'Operador Público' },
  ...
  { id: 'games_500', group: 'general_games', metric: 'gamesPlayed', threshold: 500, title: 'Leyenda Pública' },

  { id: 'wins_10', group: 'general_wins', metric: 'gamesWon', threshold: 10, title: 'Competidor Serio' },
  { id: 'wins_25', group: 'general_wins', metric: 'gamesWon', threshold: 25, title: 'Estratega Público' },
  ...
  { id: 'survival_100', group: 'general_survival', metric: 'survivedToEnd', threshold: 100, title: 'Último en Pie' },
